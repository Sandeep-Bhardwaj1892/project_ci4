...
<header>
    ...
    <div class="menu">
        <ul>
            <li class="logo"><a href="#" target="_blank"><h2>Welcome</h2> </a></li>
            <li class="menu-toggle"><button onclick="toggleMenu();">&#9776;</button> </li>
            <li class="menu-item hidden"><a href="#">Home</a></li>
            <li class="menu-item hidden"><a href="#" target="_blank">Students</a></li>
            <li class="menu-item hidden"><a href="#" target="_blank">Course</a></li>
            <li class="menu-item hidden"><a href="#" target="_blank">results</a></li>
